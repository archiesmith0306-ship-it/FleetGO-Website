...
function useGeographies(_ref) {
  ...
  var _useContext = useContext(MapContext), path = _useContext.path;
  var _useState = useState({}), _useState2 = _slicedToArray(_useState, 2), output = _useState2[0], setOutput = _useState2[1];
  useEffect(function() {
...
var Geographies = forwardRef(function(_ref, ref) {
  ...
  var _useContext = useContext(MapContext), path = _useContext.path, projection2 = _useContext.projection;
...
var Geography = forwardRef(function(_ref, ref) {
  ...
  var _useState = useState(false), _useState2 = _slicedToArray(_useState, 2), isPressed = _useState2[0], setPressed = _useState2[1];
  var _useState3 = useState(false), _useState4 = _slicedToArray(_useState3, 2), isFocused = _useState4[0], setFocus = _useState4[1];
...
var ZoomPanProvider = function ZoomPanProvider2(_ref) {
  ...
  return React.createElement(ZoomPanContext.Provider, _extends({
    value
  }, restProps));
};
...
function useZoomPan(_ref) {
  ...
  var _useContext = useContext(MapContext), width = _useContext.width, height = _useContext.height, projection2 = _useContext.projection;
...
var ZoomableGroup = forwardRef(function(_ref, ref) {
  ...
  var _useContext = useContext(MapContext), width = _useContext.width, height = _useContext.height;
  ...
  return React.createElement(ZoomPanProvider, {
    value: {
      x: position.x,
      y: position.y,
      k: position.k,
...
var Marker = forwardRef(function(_ref, ref) {
  ...
  var _useContext = useContext(MapContext), projection2 = _useContext.projection;
  var _useState = useState(false), _useState2 = _slicedToArray(_useState, 2), isPressed = _useState2[0], setPressed = _useState2[1];
  var _useState3 = useState(false), _useState4 = _slicedToArray(_useState3, 2), isFocused = _useState4[0], setFocus = _useState4[1];
